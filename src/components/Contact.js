...
const Contact = () => {
    return (
        <div class="bg-light mt-5 customHeight">
            <h2 class="py-5 w-75 d-flex justify-content-start mx-auto">Kontakt</h2>
            <div class="w-100 d-flex justify-content-around row row-cols-1 row-cols-md-2 row-cols-lg-3 mx-auto">
